const SocialMediaIcons = () => {
  return (
    <div className="relative z-30 my-10 flex justify-center gap-7 md:justify-start">
      <a
        className="hover:text-dark-pink text-white transition duration-500 hover:opacity-100"
